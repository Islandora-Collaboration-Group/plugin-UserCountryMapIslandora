...
(function () {
    ...
    window.UserCountryMapIslandora = window.UserCountryMapIslandora || {};

    // the main class for this widget, provides the interface for the template
    var VisitorMapIslandora = window.UserCountryMapIslandora.VisitorMap = function (config, theWidget) {
        this.config = config;
        this.theWidget = theWidget || false;
        this.run();
    };

    $.extend(VisitorMapIslandora.prototype, {
        ...
        run: function () {
            ...
            var mapContainer = $$('.UserCountryMapIslandora_map').get(0),
                map = self.map = $K.map(mapContainer),
                main = $$('.UserCountryIslandoraMap_container'),
                worldTotalVisits = 0,
                width = main.width(),
                _ = config._;
            ...
            $$('.widgetUserCountryMapIslandoravisitorMap .widgetName').append('<span class="map-title"></span>');
